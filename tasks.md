...
- [x] Phase 0: add the landing page to the advisor spec
- [x] Phase 0: update the site spec's ranking, route and fold rules
- [x] Phase 0: add the ask event and fix the stale CI publish comment
